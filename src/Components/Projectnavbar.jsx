  ...
  return (
    ...
    >
      ...
      <ul className="pt-4 pl-3 gap-y-3">
        ...
        <li className="text-orange-600 text-sm font-semibold font-openSans p-3">PROJECTS</li>
        <li className="text-neutral-900 text-sm font-semibold font-openSans p-3">ABOUT</li>
